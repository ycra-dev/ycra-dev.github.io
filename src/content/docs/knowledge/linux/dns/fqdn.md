...
- [dns](/knowledge/linux/dns/) - FQDN이 속하는 도메인 이름 시스템
- [dns-zone](/knowledge/linux/dns-zone/) - FQDN의 관리 단위
- [dns-resource-record](/knowledge/linux/dns-resource-record/) - FQDN을 사용하는 레코드
- [dns-resolver](/knowledge/linux/dns-resolver/) - FQDN을 해석하는 클라이언트
