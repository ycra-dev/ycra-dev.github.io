...
- [dns](/knowledge/linux/dns/) - 존이 속하는 도메인 이름 시스템
- [dns-resource-record](/knowledge/linux/dns-resource-record/) - 존 파일을 구성하는 레코드
- [soa-record](/knowledge/linux/soa-record/) - 존의 시작을 나타내는 레코드
- [dns-zone-transfer](/knowledge/linux/dns-zone-transfer/) - 마스터-슬레이브 간 존 동기화
- [bind](/knowledge/linux/bind/) - 존을 서비스하는 DNS 서버 소프트웨어
- [dns-delegation](/knowledge/linux/dns-delegation/) - 존의 하위 도메인 위임
