...
updated: 2026-02-17
draft: true
slug: knowledge/linux/dns-resolver
sidebar:
  order: 3
---
...
- [dns](/knowledge/linux/dns/) - 리졸버가 접근하는 도메인 이름 시스템
- [dhcp](/knowledge/linux/dhcp/) - resolv.conf를 자동 설정하는 프로토콜
- [dns-caching](/knowledge/linux/dns-caching/) - 네임 서버의 캐싱 동작
- [bind](/knowledge/linux/bind/) - 리졸버가 쿼리하는 DNS 서버 소프트웨어
