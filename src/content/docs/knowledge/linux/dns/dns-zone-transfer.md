...
updated: 2026-02-17
draft: true
slug: knowledge/linux/dns-zone-transfer
sidebar:
  order: 15
---
...
- [dns-zone](/knowledge/linux/dns-zone/) - 전송되는 데이터 단위
- [bind](/knowledge/linux/bind/) - 존 전송을 구현하는 DNS 서버
- [soa-record](/knowledge/linux/soa-record/) - 시리얼 번호 기반 전송 판단
- [tsig](/knowledge/linux/tsig/) - 존 전송 보안 인증
- [dynamic-dns](/knowledge/linux/dynamic-dns/) - IXFR과 트랜잭션 로그를 사용하는 동적 업데이트
