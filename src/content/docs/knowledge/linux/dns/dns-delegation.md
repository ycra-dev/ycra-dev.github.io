...
updated: 2026-02-17
draft: true
slug: knowledge/linux/dns-delegation
sidebar:
  order: 7
---
...
- [dns](/knowledge/linux/dns/) - 위임이 동작하는 도메인 이름 시스템
- [dns-zone](/knowledge/linux/dns-zone/) - 위임의 단위
- [dns-resource-record](/knowledge/linux/dns-resource-record/) - 위임에 사용되는 NS 레코드
- [dns-caching](/knowledge/linux/dns-caching/) - 위임 과정에서의 캐싱
- [bind](/knowledge/linux/bind/) - 위임을 처리하는 DNS 서버
