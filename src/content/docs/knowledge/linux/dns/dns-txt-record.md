...
updated: 2026-02-17
draft: true
slug: knowledge/linux/dns-txt-record
sidebar:
  order: 13
---
...
- [dns-resource-record](/knowledge/linux/dns-resource-record/) - TXT를 포함하는 레코드 체계
- [spf](/knowledge/linux/spf/) - TXT를 통해 배포되는 메일 인증
- [dkim](/knowledge/linux/dkim/) - TXT를 통해 배포되는 메일 서명
- [dns](/knowledge/linux/dns/) - TXT가 동작하는 도메인 이름 시스템
