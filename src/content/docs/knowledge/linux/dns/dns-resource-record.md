...
updated: 2026-02-17
draft: true
slug: knowledge/linux/dns-resource-record
sidebar:
  order: 5
---
...
- [dns-zone](/knowledge/linux/dns-zone/) - 리소스 레코드가 저장되는 존
- [soa-record](/knowledge/linux/soa-record/) - 존의 시작 레코드
- [dns-a-record](/knowledge/linux/dns-a-record/) - 이름-주소 매핑 레코드
- [dns-ptr-record](/knowledge/linux/dns-ptr-record/) - 역방향 매핑 레코드
- [dns-cname-record](/knowledge/linux/dns-cname-record/) - 별칭 레코드
- [dns-mx-record](/knowledge/linux/dns-mx-record/) - 메일 교환 레코드
- [dns-srv-record](/knowledge/linux/dns-srv-record/) - 서비스 위치 레코드
- [dns-txt-record](/knowledge/linux/dns-txt-record/) - 텍스트 정보 레코드
- [dnssec](/knowledge/linux/dnssec/) - 보안 레코드 (RRSIG, DNSKEY 등)
