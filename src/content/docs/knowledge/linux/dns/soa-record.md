...
updated: 2026-02-17
draft: true
slug: knowledge/linux/soa-record
sidebar:
  order: 6
---
...
- [dns-zone](/knowledge/linux/dns-zone/) - SOA가 정의하는 존
- [dns-resource-record](/knowledge/linux/dns-resource-record/) - SOA를 포함하는 레코드 체계
- [dns-zone-transfer](/knowledge/linux/dns-zone-transfer/) - 시리얼 번호 기반 존 동기화
- [bind](/knowledge/linux/bind/) - SOA 레코드를 처리하는 서버 소프트웨어
- [dns-caching](/knowledge/linux/dns-caching/) - SOA의 TTL 설정이 영향을 미치는 캐싱
