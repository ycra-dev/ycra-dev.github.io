...
- [ethernet](/knowledge/linux/ethernet/) - UTP가 전송하는 네트워크 프로토콜
- [optical-fiber](/knowledge/linux/optical-fiber/) - UTP의 대안적 물리적 매체
- [network-topology](/knowledge/linux/network-topology/) - UTP 기반 네트워크 설계
- [power-over-ethernet](/knowledge/linux/power-over-ethernet/) - UTP를 통한 전력 공급
