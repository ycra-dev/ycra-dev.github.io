...
- [link-state-routing](/knowledge/linux/link-state-routing/) - OSPF가 속하는 프로토콜 유형
- [routing-protocol](/knowledge/linux/routing-protocol/) - OSPF를 포함하는 상위 개념
- [rip](/knowledge/linux/rip/) - OSPF의 대안인 거리 벡터 프로토콜
- [bgp](/knowledge/linux/bgp/) - 외부 라우팅을 담당하는 프로토콜
- [routing-daemon](/knowledge/linux/routing-daemon/) - OSPF를 구현하는 소프트웨어
- [autonomous-system](/knowledge/linux/autonomous-system/) - OSPF가 동작하는 라우팅 범위
- [network-router](/knowledge/linux/network-router/) - OSPF를 실행하는 장비
