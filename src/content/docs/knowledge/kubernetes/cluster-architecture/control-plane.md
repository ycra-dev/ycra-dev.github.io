...
- [Kubernetes API Server](/knowledge/kubernetes/kubernetes-api-server/) - Control Plane의 중심 컴포넌트
- [etcd](/knowledge/kubernetes/etcd/) - 클러스터 상태를 저장하는 분산 데이터스토어
- [Kubernetes Scheduler](/knowledge/kubernetes/kubernetes-scheduler/) - Pod 스케줄링 담당
- [Workload Plane](/knowledge/kubernetes/workload-plane/) - 실제 워크로드가 실행되는 영역
- [Controller](/knowledge/kubernetes/controller/) - 객체의 원하는 상태를 실현하는 컴포넌트
