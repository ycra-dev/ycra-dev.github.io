...
- [쿠버네티스 (Kubernetes)](/knowledge/kubernetes/kubernetes/) - 마이크로서비스 관리를 자동화하는 플랫폼
- [컨테이너 (Container)](/knowledge/kubernetes/container/) - 마이크로서비스 간 환경 격리를 제공
- [서비스 (Service)](/knowledge/kubernetes/service/) - 마이크로서비스 간 통신 진입점
- [디플로이먼트 (Deployment)](/knowledge/kubernetes/deployment/) - 마이크로서비스 배포를 관리하는 객체
- [수평 확장 (Horizontal Scaling)](/knowledge/kubernetes/horizontal-scaling/) - 마이크로서비스의 독립적 확장
