...
<Mermaid diagram={`
graph TD
    Client["외부 요청"] --> LB["Load Balancer"]
    LB --> NP["Node Port (30838)"]
    NP --> Rules["Kube Proxy가 설정한 iptables/IPVS 규칙"]
    Rules --> PodA["Pod A"]
    Rules --> PodB["Pod B"]
    Rules --> PodC["Pod C"]
`} />
...
web-server version 1.0. Request processed by "web-server-9d785b578-58vhc"
$ curl 35.246.179.22:8080
web-server version 1.0. Request processed by "web-server-9d785b578-p449x"
$ curl 35.246.179.22:8080
web-server version 1.0. Request processed by "web-server-9d785b578-jmnj8"
