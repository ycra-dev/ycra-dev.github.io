...
- [컨트롤 플레인 (Control Plane)](/knowledge/kubernetes/control-plane/) - Kubernetes 클러스터의 두뇌 역할을 하는 컴포넌트
- [워크로드 플레인 (Workload Plane)](/knowledge/kubernetes/workload-plane/) - 실제 워크로드가 실행되는 워커 노드
- [선언적 모델 (Declarative Model)](/knowledge/kubernetes/declarative-model/) - Kubernetes의 선언적 배포 방식
- [컨테이너 (Container)](/knowledge/kubernetes/container/) - Kubernetes가 관리하는 기본 실행 단위
