...
updated: 2026-02-17
draft: true
slug: knowledge/mathematics/tractability
sidebar:
  order: 10
---
...
- [Time Complexity](/knowledge/mathematics/time-complexity/) - 시간 복잡도의 기본 개념
- [Big-O Notation](/knowledge/mathematics/big-o-notation/) - 복잡도 표기법
- [Halting Problem](/knowledge/mathematics/halting-problem/) - 풀 수 없는 문제의 대표적 예시
- [Algorithm](/knowledge/mathematics/algorithm/) - 알고리즘의 존재 여부와 효율성
- [Propositional Logic](/knowledge/mathematics/propositional-logic/) - SAT 문제와의 연관
