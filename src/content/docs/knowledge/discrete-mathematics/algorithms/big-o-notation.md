...
updated: 2026-02-17
draft: true
slug: knowledge/mathematics/big-o-notation
sidebar:
  order: 7
---
...
- [Big-Omega and Big-Theta Notation](/knowledge/mathematics/big-omega-and-big-theta-notation/) - 하한과 정확한 차수를 표현하는 표기법
- [Time Complexity](/knowledge/mathematics/time-complexity/) - Big-O를 활용한 알고리즘 분석
- [Algorithm](/knowledge/mathematics/algorithm/) - Big-O 분석의 대상
- [Linear Search](/knowledge/mathematics/linear-search/) - O(n) 복잡도를 가진 탐색 알고리즘
- [Binary Search](/knowledge/mathematics/binary-search/) - O(log n) 복잡도를 가진 탐색 알고리즘
