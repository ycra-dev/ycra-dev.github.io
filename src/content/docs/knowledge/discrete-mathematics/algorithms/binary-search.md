...
updated: 2026-02-17
draft: true
slug: knowledge/mathematics/binary-search
sidebar:
  order: 3
---
...
- [Linear Search](/knowledge/mathematics/linear-search/) - 선형 탐색과의 비교
- [Big-O Notation](/knowledge/mathematics/big-o-notation/) - 복잡도 O(log n) 표기
- [Time Complexity](/knowledge/mathematics/time-complexity/) - 로그 시간 복잡도
- [Sorting Algorithm](/knowledge/mathematics/sorting-algorithm/) - 이진 탐색을 위해 필요한 전제 조건
