...
updated: 2026-02-17
draft: true
slug: knowledge/mathematics/big-omega-and-big-theta-notation
sidebar:
  order: 8
---
...
- [Big-O Notation](/knowledge/mathematics/big-o-notation/) - 점근적 상한 표기법
- [Time Complexity](/knowledge/mathematics/time-complexity/) - 알고리즘 분석에서의 활용
- [Sorting Algorithm](/knowledge/mathematics/sorting-algorithm/) - 정렬 알고리즘의 Θ(n²), Θ(n log n) 복잡도
- [Mathematical Proof](/knowledge/mathematics/mathematical-proof/) - Big-O, Big-Omega 관계의 증명에 사용되는 기법
