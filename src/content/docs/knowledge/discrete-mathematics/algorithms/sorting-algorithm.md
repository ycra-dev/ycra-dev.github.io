...
updated: 2026-02-17
draft: true
slug: knowledge/mathematics/sorting-algorithm
sidebar:
  order: 4
---
...
- [Algorithm](/knowledge/mathematics/algorithm/) - 정렬 알고리즘은 알고리즘의 대표적 사례
- [Binary Search](/knowledge/mathematics/binary-search/) - 정렬된 리스트가 이진 탐색의 전제 조건
- [Time Complexity](/knowledge/mathematics/time-complexity/) - 정렬 알고리즘의 복잡도 분석
- [Big-O Notation](/knowledge/mathematics/big-o-notation/) - O(n²), O(n log n) 등의 복잡도 표기
