---
title: "사전식 순서 (Lexicographic Ordering)"
...
- [알고리즘 (Algorithm)](/knowledge/algorithms/algorithm/) - 사전식 순서 생성은 알고리즘 설계의 기초
- [빅오 표기법 (Big-O Notation)](/knowledge/algorithms/big-o-notation/) - 생성 알고리즘의 시간 복잡도 분석
