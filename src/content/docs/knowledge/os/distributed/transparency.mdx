...
- [네트워크 운영체제 vs 분산 운영체제 (NOS vs DOS)](/knowledge/os/nos-vs-dos/) - 투명성 수준이 다른 NOS와 DOS의 비교
- [분산 파일 시스템 (DFS)](/knowledge/os/dfs/) - 투명성이 핵심 설계 목표인 분산 파일 시스템
- [분산 시스템 (Distributed System)](/knowledge/os/distributed-system/) - 투명성이 요구되는 분산 시스템의 기본 구조
- [분산 시스템의 견고성 (Robustness)](/knowledge/os/distributed-robustness/) - 장애 투명성과 관련된 분산 시스템의 견고성
- [클라이언트-서버 DFS (NFS, OpenAFS)](/knowledge/os/client-server-dfs/) - NFS 마운트와 OpenAFS 전역 네임스페이스의 투명성 구현 비교
