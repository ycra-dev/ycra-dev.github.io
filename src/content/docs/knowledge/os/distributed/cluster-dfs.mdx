...
- [분산 파일 시스템 (DFS)](/knowledge/os/dfs/) - 클러스터 기반 DFS가 속하는 분산 파일 시스템의 전체 개념
- [클라이언트-서버 DFS (NFS, OpenAFS)](/knowledge/os/client-server-dfs/) - 클러스터 기반과 대비되는 전통적인 DFS 아키텍처
- [DFS 캐싱과 일관성](/knowledge/os/dfs-caching/) - GFS와 HDFS에서의 일관성 보장 메커니즘
- [분산 시스템의 견고성 (Robustness)](/knowledge/os/distributed-robustness/) - 청크 복제를 통한 장애 대응과 관련된 견고성 개념
- [분산 시스템의 확장성 (Scalability)](/knowledge/os/distributed-scalability/) - 클러스터 DFS의 수평 확장 설계 원칙
