...
- [인터럽트 (Interrupt)](/knowledge/os/interrupt/) - 명령어 실행 사이클 중 CPU가 감지하는 하드웨어 신호
- [부트스트랩 프로그램 (Bootstrap Program)](/knowledge/os/bootstrap-program/) - 전원이 켜질 때 메모리에 운영체제를 로드하는 프로그램
- [커널 (Kernel)](/knowledge/os/kernel/) - 메모리에 상주하며 실행되는 운영체제의 핵심 프로그램
- [운영체제 (Operating System)](/knowledge/os/operating-system/) - 폰 노이만 아키텍처 위에서 하드웨어를 관리하는 소프트웨어
