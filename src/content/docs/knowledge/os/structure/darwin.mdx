...
- [마이크로커널 (Microkernel)](/knowledge/os/microkernel/) - Darwin의 기반인 Mach가 속하는 마이크로커널 구조
- [하이브리드 시스템 (Hybrid Systems)](/knowledge/os/hybrid-systems/) - Darwin이 채택한 여러 구조를 결합한 접근 방식
- [Mach 운영체제](/knowledge/os/mach-overview/) - Darwin의 핵심인 Mach 마이크로커널의 전체 구조
- [적재 가능 커널 모듈 (LKM)](/knowledge/os/loadable-kernel-modules/) - Darwin의 kexts와 유사한 동적 커널 확장 방식
- [Android 구조](/knowledge/os/android/) - Darwin과 마찬가지로 Linux 기반의 계층화된 하이브리드 시스템
