...
- [SSD (Solid-State Drive)](/knowledge/os/ssd/) - NAND 플래시 관리 알고리즘이 동작하는 저장장치의 전체 구조
- [논리 블록 주소 (LBA)](/knowledge/os/lba/) - FTL이 변환하는 논리 주소 체계
- [오류 검출과 정정 (ECC)](/knowledge/os/ecc/) - NAND 페이지 단위로 적용되는 비트 오류 정정 기법
- [HDD (Hard Disk Drive)](/knowledge/os/hdd/) - FTL이 SSD를 HDD처럼 동작하게 만드는 대상 장치 모델
- [I/O 스케줄링](/knowledge/os/io-scheduling/) - SSD에서는 NOOP 스케줄러가 적합한 이유와 관련된 I/O 최적화
