...
- [논리 블록 주소 (LBA)](/knowledge/os/lba/) - 저수준 포매팅으로 생성된 섹터/페이지에 매핑되는 논리 주소 체계
- [UNIX 아이노드 (Inode)](/knowledge/os/unix-inode/) - 논리적 포매팅(mkfs) 시 생성되는 파일 메타데이터 구조
- [저널링 파일 시스템](/knowledge/os/journaling/) - ext3/ext4 포매팅 시 생성되는 저널 영역
- [RAID (Redundant Array of Independent Disks)](/knowledge/os/raid/) - 볼륨 생성 단계에서 여러 디스크를 묶는 구성 기술
- [오류 검출과 정정 (ECC)](/knowledge/os/ecc/) - 저수준 포매팅 시 각 섹터에 기록되는 ECC 트레일러
