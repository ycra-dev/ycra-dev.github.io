...
- [가상화 (Virtualization)](/knowledge/os/virtualization/) - JVM이 속하는 프로그래밍 환경 가상화를 포함한 가상화 방식 분류
- [바이너리 변환 (Binary Translation)](/knowledge/os/binary-translation/) - JVM의 JIT 컴파일과 유사하게 코드를 변환하여 실행하는 기법
- [컨테이너 (Container)](/knowledge/os/container/) - JVM과는 다른 OS 수준의 격리 기술로, 애플리케이션 배포에 활용
- [트랩 앤 에뮬레이트 (Trap-and-Emulate)](/knowledge/os/trap-and-emulate/) - 하드웨어 가상화 기법으로, JVM의 소프트웨어 에뮬레이션과 대비
