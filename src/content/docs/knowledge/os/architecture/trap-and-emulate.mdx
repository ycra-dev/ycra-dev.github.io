...
- [바이너리 변환 (Binary Translation)](/knowledge/os/binary-translation/) - x86의 special instructions 문제를 해결하기 위한 소프트웨어 기반 기법
- [하드웨어 가상화 지원 (VT-x/AMD-V)](/knowledge/os/hw-virtualization/) - trap-and-emulate를 하드웨어로 효율적으로 구현한 기술
- [가상화 (Virtualization)](/knowledge/os/virtualization/) - 가상화의 전체 개념과 VCPU 등 핵심 구성 요소
- [준가상화 (Paravirtualization)](/knowledge/os/paravirtualization/) - 트랩 대신 hypercall을 사용하는 대안 가상화 기법
- [하이퍼바이저 유형 (Type 0/1/2 Hypervisor)](/knowledge/os/hypervisor-types/) - trap-and-emulate를 활용하는 하이퍼바이저의 유형
