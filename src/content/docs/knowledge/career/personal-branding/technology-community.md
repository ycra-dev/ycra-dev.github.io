...
기술 커뮤니티는 물리적·온라인 공간에서 정보를 공유하고, 전문적 관계를 발전시키며, 서로를 지원하는 사람들의 그룹이다. 커뮤니티에서 정보를 소비만 하는 것은 기생(parasite)과 같다. 기여자가 될 때 커리어가 크게 향상된다.

## 동작 원리

**기여할 방법은 매우 다양하다:**
- 기술 블로깅, 동영상 제작
- Q&A 사이트(Stack Overflow 등)에서 질문 답변
- 오픈소스 프로젝트: 문서화, 코드 리뷰, 번역, 이슈 중재, PR 리뷰
- 팟캐스트 지원, 컨퍼런스 자원봉사
- 로컬 밋업이나 스터디 그룹 운영
