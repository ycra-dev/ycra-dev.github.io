...
- [dns-resource-record](/knowledge/network/dns-resource-record/) - SRV를 포함하는 레코드 체계
- [dns-mx-record](/knowledge/network/dns-mx-record/) - SRV의 메일 전용 선구자
- [dns](/knowledge/network/dns/) - SRV가 동작하는 도메인 이름 시스템
