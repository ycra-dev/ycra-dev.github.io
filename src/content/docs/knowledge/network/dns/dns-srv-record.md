---
title: "DNS SRV 레코드 (DNS SRV Record)"
...
updated: 2026-02-17
draft: true
slug: knowledge/network/dns-srv-record
sidebar:
  order: 12
---
...
- [DNS 리소스 레코드 (DNS Resource Record)](/knowledge/network/dns-resource-record/) - SRV를 포함하는 레코드 체계
- [DNS MX 레코드 (DNS MX Record)](/knowledge/network/dns-mx-record/) - SRV의 메일 전용 선구자
- [DNS (도메인 네임 시스템)](/knowledge/network/dns/) - SRV가 동작하는 도메인 이름 시스템
- [서비스 디스커버리 (Service Discovery)](/knowledge/linux/service-discovery/) - SRV를 활용한 서비스 발견
- [Active Directory (액티브 디렉토리)](/knowledge/linux/active-directory/) - SRV를 광범위하게 사용하는 시스템
