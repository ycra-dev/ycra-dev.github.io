...
- [어텐션 세트 (Attention Set)](/knowledge/software-engineering/quality-and-configuration/attention-set/)
- [LGTM과 승인 (LGTM and Approval)](/knowledge/software-engineering/quality-and-configuration/lgtm-and-approval/)
- [코드 리뷰 디핑 (Code Review Diffing)](/knowledge/software-engineering/quality-and-configuration/code-review-diffing/)
- [게릿 (Gerrit)](/knowledge/software-engineering/quality-and-configuration/gerrit/)
