...
이 정책은 규모에 따라 잘 확장된다. 테스트를 통해 "계약"을 명시적으로 표현하면, 인프라 변경이 안전하게 이루어질 수 있다. 이는 [Hyrum's Law](/knowledge/software-engineering/foundations/hyrums-law/)의 효과를 완화하는 실용적인 접근법이기도 하다.
