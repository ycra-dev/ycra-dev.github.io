...
도메인 주도 설계(Domain-Driven Design, DDD)는 비즈니스 도메인(회계, 청구, 배송 등)에 맞춰 소프트웨어 컴포넌트를 구성하는 아키텍처 접근법이다. Eric Evans의 2003년 저서 "Domain-Driven Design"에서 체계화되었다. 도메인 지식을 캡슐화하면 높은 응집도와 낮은 결합도를 달성할 수 있으며, 변경의 "폭발 반경"을 줄인다.
