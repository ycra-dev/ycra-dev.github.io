		...
		starlight({
			...
			sidebar: [
					...
					items: [
						...
						// },
						{
							...
							items: [
								...
								{ label: 'DNS', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/network/dns' } }] },
								{ label: 'Email', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/network/email' } }] },
							],
						},
						{
							label: 'OS',
							...
							items: [
								{ slug: 'knowledge/os' },
								{ label: '기본 개념', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/basics' } }] },
								{ label: '프로세스와 스레드', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/process' } }] },
								{ label: 'CPU 스케줄링', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/scheduling' } }] },
								{ label: '동기화와 교착 상태', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/synchronization' } }] },
								{ label: '메모리 관리', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/memory' } }] },
								{ label: 'I/O 시스템', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/io' } }] },
								{ label: '저장장치', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/storage' } }] },
								{ label: '컴퓨터 시스템 구조', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/architecture' } }] },
								{ label: '분산 시스템', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/distributed' } }] },
								{ label: '운영체제 서비스', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/services' } }] },
								{ label: '보호', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/protection' } }] },
								{ label: '보안', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/security' } }] },
								{ label: '운영체제 구조', collapsed: true, items: [{ autogenerate: { directory: 'knowledge/os/structure' } }] },
							],
						},
						// {
				...
				},
				{
					label: 'TIL',
					collapsed: true,
					items: [{ autogenerate: { directory: 'til' } }],
				},
			],
		}),
		sitemap({
